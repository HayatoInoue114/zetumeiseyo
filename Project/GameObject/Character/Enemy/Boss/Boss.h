...
class Boss : public IEnemy, public OBBCollider
{
public:
...
private:
	//射撃のクールタイム
	const int bulletCoolTime = 20;
	const int mBulletCoolTime = 300;
	int nowCT = 0;
	int nowMCT = 0;
	...
	const int howManyExtraBullet = 4;
	const int howManyMortorBullet = 6;
	const float diffusionRate = 0.025f;
};
